...
class App extends Component {
  constructor(props) {
      ...
      movies: [
        {
          ...
          name: "BatMan",
          image:
            "https://batman-on-film.com/wp-content/uploads/2019/10/2_EO-Batman-RP-JR-e1575916099713.png",
          rating: 5,
          year: "2012",
        },
        {
    ...
    setTimeout(() => {this.setState({ verify: true })}, 2000);
  }
  addMovie = (movi) => {
        ...
        <ListMovies
          movies={this.state.movies.filter(
            (el) =>
              ...
              el.name
                .toLocaleUpperCase()
                .includes(this.state.keyword.toLocaleUpperCase().trim())
          )}
